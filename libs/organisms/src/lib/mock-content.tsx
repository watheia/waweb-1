    ...
    <div className="relative overflow-hidden bg-white py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          <h1>
            <span className="block text-center text-base font-semibold uppercase tracking-wide text-teal-600">
              Introducing
            </span>
        ...
        <div className="prose prose-teal prose-lg mx-auto mt-6 text-gray-500">
          <p>
